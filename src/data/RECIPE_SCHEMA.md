...
- `diet`: `vegetarisch` bei allem ohne Fleisch/Fisch; `vegan` zusätzlich, wenn auch ohne Ei/Milchprodukte/Honig. `proteinreich` ab ca. 25 g Protein pro Portion. `lowcarb` unter ca. 20 g Kohlenhydrate. `kalorienarm` unter ca. 400 kcal. `glutenfrei`/`laktosefrei` nur wenn wirklich zutreffend.
